...
const CardSnipet = () => {
  return (
    <Link href={"#"} className="bg-[#323443] rounded-[1.25em] pt-[1.5em] px-[2.5em] relative min-h-[10em] md:min-h-[17.625em] pb-[5.625em]">
      <p className="text-[1.25em] md:text-[1.75em] leading-[257%] font-bold text-[#DEDEDE]">Nextjs Starter</p>
      <p className="text-[.875em] md:text-[1.125em] text-[#DEDEDE]">A dead simple for nextjs project.</p>
