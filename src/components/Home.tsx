...
const HomeComponent = ({ endLoading }: HomeComponentProps) => {
  return (
    <section className="py-12 md:py-24" id="about">
      <div className="container px-5">
        ...
        <div className="overflow-hidden">
          <h1
            className={`text-[2rem] md:text-6xl font-bold bg-gradient-to-br from-[#3BF686] to-[#4CA9FF] bg-clip-text text-transparent leading-[36px] md:leading-[72px] max-w-[1029px] transition-transform duration-500 ${endLoading ? "translate-y-0" : "translate-y-full"
              }`}
          >
            {"Hi, I'm Jarot - a passionate"}
          </h1>
        </div>
        <div className="overflow-hidden">
          <h1
          ...
          >
            Developer dedicated to continuous
          </h1>
        </div>
        <div className="overflow-hidden">
          <h1
          ...
          >
            learning &amp; impactful teamwork.
          </h1>
        </div>

        {/* Biography & Socials */}
        <div
          className={`mt-16 block md:flex gap-20 transition-opacity duration-500 ${endLoading ? "opacity-100" : "opacity-0"
            } delay-[600ms]`}
        >
          <div className="flex flex-col md:flex-row gap-9">
            <div className="bg-gradient-to-tr from-[#3BF686] to-[#62D9FF] p-1 rounded-full w-40 h-40 overflow-hidden self-center md:self-auto flex-shrink-0">
            ...
            <div className="max-w-[690px]">
              <h2 className="text-[28px] leading-[48px] md:leading-[72px] font-semibold text-white">
                Biography
              </h2>
              <p className="text-lg leading-8 text-[#D6D6D6] mb-6">
                Driven by continuous learning, clean documentation, and
                effective team collaboration. Passionate about building modern{" "}
                <span className="text-[#4CA9FF] font-bold">Frontend</span> &amp;{" "}
                <span className="text-[#80FFA3] font-bold">Backend</span>{" "}
          ...
          <div className="mt-8 md:mt-0">
            ...
            <div className="flex gap-4">
              ...
              <Link
                href="https://www.linkedin.com/in/jarot-setiawan-947275214/"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <Link
                href="mailto:jarotsetiawan1001@gmail.com"
              ...
              >
                ...
                >
                  <path
                    d="M26.2549 23.5H23.7549V12.5625L16.2549 17.25L8.75488 12.5625V23.5H6.25488V8.5H7.75488L16.2549 13.8125L24.7549 8.5H26.2549M26.2549 6H6.25488C4.86738 6 3.75488 7.1125 3.75488 8.5V23.5C3.75488 24.163 4.01827 24.7989 4.48712 25.2678C4.95596 25.7366 5.59184 26 6.25488 26H26.2549C26.9179 26 27.5538 25.7366 28.0226 25.2678C28.4915 24.7989 28.7549 24.163 28.7549 23.5V8.5C28.7549 7.83696 28.4915 7.20107 28.0226 6.73223C27.5538 6.26339 26.9179 6 26.2549 6Z"
                    fill="white"
                  />
                </svg>
              </Link>
        ...
        {/* What I Do Section */}
        <div
          className={`mt-20 flex flex-col gap-2 transition-opacity duration-500 ${endLoading ? "opacity-100" : "opacity-0"
            } delay-[800ms]`}
        >
          <div>
            <h2 className="text-[28px] leading-[48px] md:leading-[72px] font-semibold text-white mb-2">
              What I do
            </h2>
            <p className="text-lg text-[#D6D6D6]">
              I design, build, and maintain scalable, high-performance web applications.
            </p>
          </div>

          <div className="text-base md:text-lg">
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
              <span className="font-bold text-[#4CA9FF]">
                Frontend :
              </span>
              <span className="text-[#D6D6D6]">
                React.js, Next.js, Vue.js, Nuxt.js, GSAP, Webflow
              </span>
            </div>

            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
              <span className="font-bold text-[#80FFA3]">
                Backend :
              </span>
              <span className="text-[#D6D6D6]">
                Express.js, NestJS, Laravel, CodeIgniter
              </span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-3">
              ...
              <span className="text-[#D6D6D6]">
                Docker, WebSocket, Payment Gateways, Redis, Nginx, Cloudflare
              </span>
            </div>
          </div>
        </div>
